...
alias ls='eza --group-directories-first' # Basic replacement for ls with eza
...
# fnm
FNM_PATH="/home/jlainshears/.local/share/fnm"
if [ -d "$FNM_PATH" ]; then
  export PATH="/home/jlainshears/.local/share/fnm:$PATH"
  eval "`fnm env`"
fi

# pnpm
export PNPM_HOME="/home/jlainshears/.local/share/pnpm"
case ":$PATH:" in
  *":$PNPM_HOME:"*) ;;
